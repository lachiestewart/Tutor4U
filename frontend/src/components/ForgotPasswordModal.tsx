...
const ForgotPasswordModal = (props: ForgotPasswordModalProps) => {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 mb-[588px] mt-10 flex w-auto -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-[10px] bg-gray-200_01 px-[50px] py-5 md:mt-0 md:px-5 sm:w-full">
