...
const ForgotPasswordModal = (props: ForgotPasswordModalProps) => {
  ...
  return (
    <div className="relative z-10">
      <div
        className="fixed top-0 flex h-[100vh] w-[100vw] bg-gray-900 opacity-50"
        onClick={() => props.onHide()}
      ></div>
      <div className="fixed top-1/2 left-1/2 mb-[588px] mt-10 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-[10px] bg-gray-200_01 px-[50px] py-5 md:mt-0 md:w-auto md:px-5 sm:w-full">
        <div
        ...
        <div className="flex w-auto flex-col items-center justify-start gap-2.5 py-5 sm:w-full">
          ...
          >
            Enter your email below and a reset password link will be sent to
            your inbox
          </Text>
          <form
