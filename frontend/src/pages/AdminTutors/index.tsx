      ...
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-montserrat sm:gap-5 md:gap-5 items-start justify-center mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-col gap-5 items-center justify-start max-w-[1060px] p-[30px] md:px-5 w-full">
          ...
          <div className="flex flex-col font-inter items-start justify-start w-full">
            <div className="bg-blue_gray-100 flex md:flex-col flex-row md:gap-5 items-start justify-start rounded-tl-[10px] rounded-tr-[10px] w-auto md:w-full">
          ...
          <div className="bg-blue_gray-100 flex flex-col font-montserrat items-start justify-start rounded-[10px] w-full">
            <div className="border-r-[5px] border-solid border-white-A700 flex flex-col items-start justify-start w-[393px] sm:w-full">
              <div className="flex flex-row gap-2.5 items-center justify-between sm:px-5 px-[23px] py-[18px] w-full">
                <Text
                  className="sm:text-2xl md:text-[26px] text-[28px] text-black-900 w-[203px]"
                  size="txtMontserratRomanSemiBold28"
                >
                  Login Created
                </Text>
                <Text
                  className="sm:text-2xl md:text-[26px] text-[28px] text-black-900 text-center w-[42px]"
                  size="txtMontserratRomanSemiBold28"
                >
                  ##
                </Text>
              ...
              <div className="flex flex-row gap-2.5 items-center justify-between sm:px-5 px-[23px] py-[18px] w-full">
                <Text
                  className="sm:text-2xl md:text-[26px] text-[28px] text-blue_gray-400 w-[181px]"
                  size="txtMontserratRomanSemiBold28Bluegray400"
                >
                  Applications
                </Text>
                <Text
                  className="sm:text-2xl md:text-[26px] text-[28px] text-blue_gray-400 text-center w-[42px]"
                  size="txtMontserratRomanSemiBold28Bluegray400"
                >
                  ##
                </Text>
              ...
              <div className="flex flex-row gap-2.5 items-center justify-between sm:px-5 px-[23px] py-[18px] w-full">
                <Text
                  className="sm:text-2xl md:text-[26px] text-[28px] text-blue_gray-400 w-[151px]"
                  size="txtMontserratRomanSemiBold28Bluegray400"
                >
                  Interviews
                </Text>
              ...
              <div className="flex flex-row gap-2.5 items-center justify-between sm:px-5 px-[23px] py-[18px] w-full">
                <Text
                  className="flex-1 sm:text-2xl md:text-[26px] text-[28px] text-blue_gray-400 w-auto"
                  size="txtMontserratRomanSemiBold28Bluegray400"
                >
                  Code of Conduct
                </Text>
              ...
              <div className="flex flex-row gap-2.5 items-center justify-between sm:px-5 px-[23px] py-[18px] w-full">
                <Text
                  className="sm:text-2xl md:text-[26px] text-[28px] text-blue_gray-400 w-[190px]"
                  size="txtMontserratRomanSemiBold28Bluegray400"
                >
                  Active Tutors
                </Text>
