    ...
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat gap-[30px] items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="bg-white-A700 flex md:flex-col flex-row gap-2.5 items-center justify-between md:px-10 sm:px-5 px-[60px] py-[15px] w-full">
          ...
          <div className="flex flex-1 flex-col h-[595px] md:h-auto items-center justify-center max-w-[637px] w-full">
            <Text
          ...
          >
            <div className="flex flex-1 flex-col gap-2.5 items-center justify-start max-w-[650px] w-full">
              <Img
                ...
                alt="imageThree"
              />
              <div className="flex flex-row gap-[43px] h-12 md:h-auto items-center justify-start w-auto">
                <Text
