              ...
              <div className="flex w-full flex-col items-center justify-start gap-5">
                ...
                >
                  <>
                    ...
                    following code of conduct during your onboarding. If any of
                    the below rules are broken, your account may be suspended
                    without notice. <br />
                ...
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  ...
                  >
                    ...
                    the Tutor4U community, you will be representing our brand
                    with anyone that interacts with the platform. This includes
                ...
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  ...
                  >
                    <>
                      You will be punctual with communication and interactions
                      on the platform. This includes getting back to any
                      students in a timely fashion with regards to setting up
                      future lessons as well as any feedback they require that
                      could help them reach their academic potential. This also
                      includes ensuring that you turn up for all your scheduled
                      lessons on time, at the appropriate location as previously
                ...
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  ...
                  >
                    ...
                    As a tutor, you will be in a position of authority. Maintain
                    professional boundries and do not meet students outside of
                    scheduled sessions, whether online or in-person. Do not
                    contact your students outside of the platform if such
                    contact is unrelated to tutoring.
                  </Text>
                </div>
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  <Text
                ...
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  ...
                  >
                    ...
                    students tutoring services outside of the Tutor4U platform
                    if those students were originally introduced by Tutor4U. All
                ...
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  ...
                  >
                    ...
                    authorities.  Any violations will be treated on a
                    case-by-case basis.
                  </Text>
                </div>
                <div className="flex w-full flex-col items-start justify-start gap-[5px]">
                  ...
                  >
                    ...
                    about these changes. This extends to any criminal
