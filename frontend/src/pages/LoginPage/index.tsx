  ...
  return (
    <>
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-montserrat sm:gap-5 md:gap-5 items-center mx-auto w-full">
        ...
        <div className="flex flex-col items-center justify-center p-[89px] md:px-5">
          <Text
          ...
          <a
            href="javascript:"
            className="bg-blue-A200 h-[50px] justify-center mb-[321px] mt-8 sm:px-5 px-[35px] py-[13px] rounded-[10px] text-center text-lg text-white-A700 w-[150px]"
          >
            <Text size="txtMontserratRomanBlack18">
