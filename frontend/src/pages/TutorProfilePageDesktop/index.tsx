...
const TutorProfilePageDesktopPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-200 flex flex-col font-montserrat items-center justify-start mx-auto md:px-10 sm:px-5 px-[215px] py-[29px] w-auto sm:w-full md:w-full">
        <div className="bg-white-A700 flex md:flex-col flex-row gap-[21px] items-start justify-start max-w-[977px] mx-auto md:px-5 px-6 py-2.5 rounded-[10px] w-full">
          ...
          <div className="flex md:flex-1 flex-col gap-[11px] items-start justify-start p-[15px] w-auto md:w-full">
            ...
            <div className="bg-blue_gray-100 flex flex-col gap-[22px] items-center justify-start pb-5 pt-[13px] px-[15px] rounded-[10px] w-[570px] sm:w-full">
              <Text
                className="leading-[36.00px] max-w-[495px] md:max-w-full sm:text-2xl md:text-[26px] text-[28px] text-black-900 text-center"
                size="txtMontserratRomanSemiBold28"
              >
                Create Login to Get in touch with (FName) for Free
              </Text>
...
export default TutorProfilePageDesktopPage;
