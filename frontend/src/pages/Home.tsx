              ...
              <div className="lg:flex-row mx-auto flex w-full max-w-[1320px] gap-5 sm:flex-col">
                  ...
                  <div>
                    ...
                    <div className="flex w-full flex-col items-center justify-start rounded-[10px] bg-gray-400_01 p-[5px] px-2 text-justify">
                      <p>
                        ...
                        It's been awesome - within weeks I had students getting
                        in contact for tutoring, allowing me to help them learn
                        the science I'm passionate about whilst putting some
                        money in my back pocket! I would definitely recommend
                ...
                <div className="lg:flex-col flex w-full items-center justify-start gap-5 sm:flex-row-reverse">
                  ...
                  <div>
                    ...
                    <div className="flex w-full flex-col items-center justify-start rounded-[10px] bg-gray-400_01 p-[5px] px-2 text-justify">
                      <p>
                        Tutor4U has been a great platform to get myself out
                        there and directly connect with students. I have been
                        tutoring for a few years now- usually I have to find the
                        students through different ways but the students now
                        come to me. No signing to be contracted with tutoring
                        companies either. Just a service that connects students
                        directly to tutors. Easy to set up and the students come
                        rolling to you.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="info-blocks-wrapper">
                      <div className="info-blocks">
                        ...
                        <div className="info-information">
                          <p>
                            Tutor4U allows you to easily find private tutors
                            from around NZ based on your needs so that you can
                            find one as quickly as possible!
                            <br />
                            <br />
                            All our tutors have been through interviews and
                            academic checks when they register ensuring top
                            quality of all the tutors on the platform.
                          </p>
                          <Button
                      ...
                      <div className="info-blocks">
                        ...
                        <div className="info-information">
                          ...
                          <p>
                            ...
                            system so that you can quickly and easily find a
                            tutor that suits your needs.
                            <br />
                            <br />
                      ...
                      <div className="info-blocks">
                        ...
                        <div className="info-information">
                          ...
                          <p>
                            ...
                            you'll be able to see their key details and
                            information so you can know a little about them
                        ...
                        <div className="info-information">
                          <p>
                            <>
                              ...
                              <br />
                              Each profile has a contact form to fill out that
                              will allow you to email the tutor directly. They
                              will then receive your details and reply to you so
                              that you can organise a tutoring session.
                            </>
                          </p>
                        </div>
                      </div>
                  ...
                  <FadeIn>
                    <div className="info-blocks-wrapper">
                      <div className="info-blocks">
                        ...
                        <div className="info-information">
                          <p>
                            ...
                            <br />
                            <br />
                            Tutor4U allows all tutors to customise their
                            profiles so that they can work on their own terms!{" "}
                            <br />
                            ...
                            <br />
                            <br />
                            Additionally, every tutor gets their very own
                            detailed personalised profile page where potential
                      ...
                      <div className="info-blocks">
                        <h4 className="info-title">
                          <>
                            Step 1. Create a Login & Complete A Tutor
                            Application
                          </>
                        </h4>
                        <div className="info-information">
                          <p>
                            ...
                            <br />
                            <br />
                            The first step is to create a login. You will then
                            get taken through the onboarding process when you
                            jump into the Tutor4U login portal.
                            <br />
                            <br />
                            Once you have completed your application with all
                            your details, our team will review them to see if
                            you're a good fit for tutoring.
                          </p>
                          <Button
                      ...
                      <div className="info-blocks">
                        ...
                        <div className="info-information">
                          ...
                          <p>
                            ...
                            better. The key things we will want to know are why
                            you want to tutor, if you have any teaching
                            experience and what you do outside of academics :)
                            <br />
                            <br />
                            It's also a great opportunity to ask us questions if
                            you have any!
                          </p>
                        </div>
                      </div>
                      <div className="info-blocks">
                        ...
                        <p className="info-information">
                          ...
                          platform, the final step is for you to accept our Code
                          of Conduct. This will be on your login portal to
                          accept.
                        </p>
                      </div>
                      <div className="info-blocks">
                        ...
                        <div className="info-information">
                          <p>
                            Once all the above steps are taken care of there is
                            only 1 last thing to do: Publish your profile!
                            <br />
                            <br />
                      ...
                      <div className="info-blocks">
                        ...
                        <div className="lg:pl-10 flex w-full flex-1 flex-col items-start justify-start border-l-2 border-gray-400 py-5 md:pl-5">
                          <p>
                            ...
                            profile page, you will receive the message directly
                            to your email inbox. From there it's your
                            responsibility to get back to them and manage the
