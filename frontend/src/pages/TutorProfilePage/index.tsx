...
const TutorProfilePagePage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-200 flex flex-col font-montserrat items-center justify-start mx-auto md:px-10 sm:px-5 px-[215px] py-[29px] w-auto sm:w-full md:w-full">
        <div className="bg-white-A700 flex md:flex-col flex-row gap-[21px] items-start justify-start md:justify-start max-w-[977px] mx-auto md:px-5 px-6 py-2.5 rounded-[10px] w-full">
          <div className="flex flex-col gap-3.5 h-[907px] md:h-auto items-center justify-start md:justify-start md:m-auto md:p-[] sm:px-5 px-[33px] md:px-[auto] py-2.5 w-[358px]">
          ...
          <div className="flex md:flex-1 flex-col gap-[11px] items-start justify-start p-[15px] w-auto md:w-full">
            ...
            <div className="bg-blue_gray-100 flex flex-col gap-[22px] items-start justify-start md:m-auto pb-5 pt-[13px] px-[15px] rounded-[10px] w-[570px] sm:w-full">
              <Text
...
export default TutorProfilePagePage;
