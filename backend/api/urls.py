...
from .views import RegisterUserView, AllUsersView, AllStudentsView, AllTutorsView, PaymentIntentView
...
urlpatterns = [
    ...
    path('make_payment/', PaymentIntentView.as_view(), name='make_payment'),
]